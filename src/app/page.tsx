...
export default function HomePage() {
  return <>
    ...
    <section className="section" style={{ background: "var(--mint)" }}><div className="section-inner"><div className="proof-hero"><div><p className="eyebrow">The reason to win</p><h2>Proof of Fix.</h2><p>Most reporting tools stop when a ticket is marked resolved. FixSA asks the resident whether the repair actually worked—then verifies the outcome or reopens the work automatically. Trust is the product.</p><div className="proof-actions"><Link href="/verify?ref=FSA-2026-1811" className="button button-primary"><CheckCircle2 size={18}/> Verify a claimed repair</Link></div></div><div className="proof-seal"><CheckCircle2/><strong>Resident<br/>verified</strong></div></div></div></section>

    <section className="section" style={{ background: "var(--white)" }}><div className="section-inner"><div className="panel" style={{ background: "var(--forest)", color: "white", padding: "clamp(28px,5vw,60px)" }}><p className="eyebrow" style={{ color: "var(--lime)" }}>Judge-ready demo</p><div className="page-header" style={{ marginBottom: 0 }}><div><h2>See the whole voice-agent journey.</h2><p className="lede" style={{ color: "#b5c9c1" }}>Run intake, duplicate, safety-stop, and resident Proof of Fix scenarios—no API key required.</p></div><Link href="/demo" className="button button-primary">Open scenarios <ArrowRight size={18}/></Link></div></div></div></section>
